  ...
  return (
    <Container>
      ...
      <div className="space-y-2">
        ...
        <ul className="list-disc ml-5">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to babyBliss, Cox's Bazar, Chittagong.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to babyBliss, accessible from{" "}
              <a
                href="https://baby-care-store-tawny.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://baby-care-store-tawny.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="text-2xl">Acknowledgment</h2>
        <p>
        ...
        <h2 className="text-2xl">Disputes Resolution</h2>
        <p>
          If You have any concern or dispute about the Service, You agree to
          first try to resolve the dispute informally by contacting the Company.
        </p>
        <h2 className="text-2xl">For European Union (EU) Users</h2>
        <p>
          If You are a European Union consumer, you will benefit from any
          mandatory provisions of the law of the country in which You are
          resident.
        </p>
        <h2 className="text-2xl">United States Legal Compliance</h2>
        <p>
        ...
        <h2 className="text-2xl">Severability and Waiver</h2>
        <h3 className="text-xl">Severability</h3>
        <p>
        ...
        <h3 className="text-xl">Waiver</h3>
        <p>
        ...
        <h2 className="text-2xl">Translation Interpretation</h2>
        <p>
          These Terms and Conditions may have been translated if We have made
          them available to You on our Service. You agree that the original
          English text shall prevail in the case of a dispute.
        </p>
        <h2 className="text-2xl">Changes to These Terms and Conditions</h2>
        <p>
        ...
        <ul className="list-disc ml-5">
          <li>
            ...
            <a
              href="https://baby-care-store-tawny.vercel.app/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://baby-care-store-tawny.vercel.app/contact-us
            </a>
          </li>
        </ul>
      </div>
